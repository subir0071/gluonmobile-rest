...
import com.gluonapplication.views.TernaryView;
...
public class GluonApplication extends MobileApplication {
    ...
    public static final String TERNARY_VIEW = "Ternary";
    ...
    public void init() {
        ...
        addViewFactory(PRIMARY_VIEW, () -> new TernaryView().getView());
        addViewFactory(ADD_VIEW, () -> new TernaryView().getAddView());
