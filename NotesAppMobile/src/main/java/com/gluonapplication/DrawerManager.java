...
public class DrawerManager {
    ...
    public DrawerManager() {
       ...
       /* final Item primaryItem = new ViewItem("Primary", MaterialDesignIcon.HOME.graphic(), PRIMARY_VIEW, ViewStackPolicy.SKIP);
        ...
        final Item ternaryItem = new ViewItem("Notes", MaterialDesignIcon.HOME.graphic(), "Notes");
        final Item addViewItem = new ViewItem("Add View", MaterialDesignIcon.HOME.graphic(), "Notes");
        drawer.getItems().addAll(ternaryItem, addViewItem);
